...
&& aws ec2 run-instances --image-id ami-0a261c0e5f51090b1 --instance-type t2.micro --count 1 --subnet-id $net1_id --security-group-ids $sg --associate-public-ip-address --key-name lab2-key \
